...
def index(request):
	ctx = {}
	date = datetime.today()
	ctx['first'] = 'This is the index page , hello!'
	ctx['date'] = date.strftime("%Y-%m-%d") 
...
"""
# to use a RequestContext to autoload some certain variables.
but django supports some RequestContext processors for use.
